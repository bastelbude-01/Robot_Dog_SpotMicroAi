...
// Define servo motor connections (expand as required)  TEST AUFBAU
...
void UpdatePosition(double J1, double J2, double J3) {
  ...
  pca9685.setPWM(SER0, 0, 90 - J2);
  pca9685.setPWM(SER1, 0, 90 - J1);
  pca9685.setPWM(SER2, 0, J3 + J3_LegAngle - 90);
  /*
    Joint1.write(90 - J1);
    Joint2.write(90 - J2);
